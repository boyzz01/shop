    ...
    <section class="checkout">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8">
                    <img src="{{ asset('storage/bukti/1RXpid1qrinnCSs0cImWq6uYTI81Tyj7ziZXUvDZ.png') }}" alt="">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <input type="text" id="personal-name" class="form-control"
                                                            name="personal_name" placeholder="Masukkan Nama Anda"
                                                            value="{{ Auth::check() ? Auth::user()->name : '' }}"
                                                            {{ Auth::check() ? 'readonly' : '' }}>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <input type="email" id="personal-email" class="form-control"
                                                            name="personal_email" placeholder="Masukkan Email Anda"
                                                ...
                                                @if (!Auth::check())
                                                    <div class="row">
                                                        <div class="col-lg-12 mt-3">
                                                            ...
                                                            <label for="open-pass">Buat Akun ?</label>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 {{ $digital == 1 ? 'd-none' : '' }}">
                                                        <select class="form-control" id="shipop" name="shipping"
                                                            required="">
                                                            <option value="shipto">Antar Ke Alamat</option>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <input class="form-control" type="text"
                                                            name="customer_address" placeholder="Alamat" required=""
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input type="text" id="Order_Note" class="form-control"
                                                            name="order_note"
                                                            placeholder="Catatan Pesanan ({{ __('Optional') }})">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-lg-12  mt-3">
                                                    <div class="bottom-area paystack-area-btn">
                                                        <button type="submit" class="mybtn1 ">Selanjutnya</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="col-lg-12 mt-3">
                                                    <div class="bottom-area">
                                                        <a href="javascript:;" id="step1-btn"
                                                            class="mybtn1 mr-3">Kembali</a>
                                                        <a href="javascript:;" id="step3-btn" class="mybtn1">Lanjut</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                @if (Auth::check())
                                    @if (Auth::user()->balance > 0)
                                        <div class="mt-3 d-flex">
                                            <input class="styled-checkbox" id="wallet" type="checkbox"
                                                value="value1">
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        $('.payment').on('click', function() {
            ...
            $($('#v-pills-tabContent #' + $(this).attr('aria-controls'))).addClass('active show').load($(this).attr(
                'data-href'));
        })
        ...
        $('#step3-btn').on('click', function() {
            ...
            var shipping_user = !$('input[name="shipping_name"]').val() ? $('input[name="customer_name"]').val() :
                $('input[name="shipping_name"]').val();
            var shipping_location = !$('input[name="shipping_address"]').val() ? $('input[name="customer_address"]')
                .val() : $('input[name="shipping_address"]').val();
            var shipping_phone = !$('input[name="shipping_phone"]').val() ? $('input[name="customer_phone"]')
                .val() : $('input[name="shipping_phone"]').val();
            var shipping_email = !$('input[name="shipping_email"]').val() ? $('input[name="customer_email"]')
                .val() : $('input[name="shipping_email"]').val();
