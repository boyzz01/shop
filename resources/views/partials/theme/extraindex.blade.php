                        ...
                        <div class="thumb-latest-blog text-center transation hover-img-zoom mb-3">
                            ...
                            <div class="post-content">
                                <h3><a href="{{ route('front.blogshow', $blog->slug) }}"
                                        class="transation text-dark hover-text-primary d-table my-10 mx-sm-auto">{{ mb_strlen($blog->title, 'UTF-8') > 200 ? mb_substr($blog->title, 0, 200, 'UTF-8') . '...' : $blog->title }}</a>
                                </h3>
            ...
            <div class="col-lg-4 col-md-6">
                ...
                <div class="footer-widget media-widget mb-5">
                    @foreach (DB::table('social_links')->where('user_id', 0)->where('status', 1)->get() as $link)
                        @if ($link->nama == 'Tiktok')
                            <a href="{{ $link->link }}"><svg style="width: 15px"
