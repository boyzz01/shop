            ...
            <div class="col-xl-7 col-md-9">
                <nav class="navbar navbar-expand-lg nav-dark nav-primary-hover nav-line-active">
                    <a class="navbar-brand" href="{{ route('front.index') }}"><img class="nav-logo lazy"
                            style="max-width: 80px" data-src="{{ asset('assets/images/' . $gs->logo) }}"
                    ...
                    <div class="product-search-one flex-grow-1 global-search touch-screen-view">
                        <form id="searchForm" class="search-form form-inline search-pill-shape"
                            ...
                            <input type="text" id="prod_name" class="col form-control search-field " name="search"
                                placeholder="Cari Produk" value="{{ request()->input('search') }}">
                        ...
                        <ul class="my-account-popup">
                            ...
                            @else
                                <li><a href="{{ route('user.login') }}"><span
                                            class="menu-item-text sign-in">Login</span></a></li>

                                <li><a href="{{ route('user.register') }}"><span
                                            class="menu-item-text join">Daftar</span></a></li>
                            @endif
