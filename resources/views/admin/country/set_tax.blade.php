                        ...
                        <div class="col-lg-7">
                          <input type="text" name="tax" class="input-field" placeholder="{{__('Enter Tax')}}"  value="{{$country->tax}}">
                                ...
                                <div class="show_state">
                                    <hr>
                                    <u>
                                        <h4 class="text-center mb-3">{{ $country->country_name }} / Ongkos Kirim Ke
                                            Provinsi
                                        </h4>
                                    </u>
                                    <br>
                                    @forelse ($country->states as $state)
                                        <div class="row">
                                            <div class="col-lg-4">
                                                <div class="left-area">
                                                    <h4 class="heading">{{ __($state->state) }} (Rp) *</h4>
                                                </div>
                                            </div>
                                            <div class="col-lg-7">
                                                <input type="number" class="input-field" name="state_tax[]"
                                                    placeholder="Masukkan Ongkir" value="{{ $state->tax }}">
                                            </div>
                                        </div>
                                    @empty
