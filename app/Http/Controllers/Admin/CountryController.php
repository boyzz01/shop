...
class CountryController extends Controller
{
    ...
    public function datatables()
    {
        ...
        return DataTables::of($datas)
            ->addColumn('action', function (Country $data) {
                return '<div class="action-list"><a href="' . route('admin-state-index', $data->id) . '"><i class="fas fa-city"></i> Atur Provinsi</a></div>';
            })
    ...
    public function taxDatatables()
    {
        ...
        return DataTables::of($datas)
            ->addColumn('action', function (Country $data) {
                return '<div class="action-list"><a href="' . route('admin-set-tax', $data->id) . '" class="edit"> <i class="fas fa-edit"></i> Atur Ongkir</a></div>';
            })
